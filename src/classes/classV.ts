import { Industry } from './classI'

export class Venture extends Industry {
  constructor() {
    this.cost = 10;
...
export class FoodService extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 10;
...
export class Farmer extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 20;
...
export class FoodCompany extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 30;
...
export class Professional extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 10;
...
export class Producer extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 20;
...
export class Sports extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 30;
...
export class Branding extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 10;
...
// Retail venture 2
// Become a famous
export class Fame extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 20;
...
// Retail venture 3
// Franchising
export class Franchise extends Industry {
    constructor() {
        //this.name = name;
        super();
        this.cost = 30;
